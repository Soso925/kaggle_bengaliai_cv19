...
from models.model import model_toto, model_toto2, model_toto3
...
if __name__ == '__main__':
    ...
    #preprocess
    train_img_df = train_img_df[:1000].drop(['image_id'], axis=1)
    ...
    #train
    toto = model_toto3(summary = False, plot_summary = False)
